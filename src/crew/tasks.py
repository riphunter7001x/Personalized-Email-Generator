...
# Class for Personalize Email Task
class PersonalizeEmailTask():
    # Task to personalize an email using recipient information and a template
        ...
        return Task(
            description=f"""
                ...
                - When personalizing the email, only use one sentence from the bio or last conversation.
                  And make sure to incorporate it naturally into the email.
    ...
    # Task to ghostwrite an email draft to match a specific writing style
